# TODO: Translation updated at 2021-10-28 11:23
translate thai style default:
    font "fonts/NotoSerifThai-Regular.ttf"
    size 36

# game/script.rpy:76
translate thai start01:

    # "...They're gone. Everyone's gone. My body aches, but I'm still alive." id start01
    "ฉันจะต้องทำตัวเงียบๆเข้าไว้ไม่งั้นเจ้ายักษ์นี่จะตื่นเอา" id start01

# game/script.rpy:77
translate thai start02:
    ...
    "แต่ถ้าฉันสามารถจุดไฟเผาบ้านมันเสียมันก็จะได้ตายในขณะที่มันกำลังหลับไปเลย" id start02

# game/script.rpy:87
translate thai light01:

    # "My fingers are numb from the cold. I need this fire. I need to feel warm again." id light01
    "ฉันรู้แล้วว่าฉันจะต้องทำยังไง ฉันยังมียาของคุณตาอยู่กับตัวนี่นา มีแค่วิธีเดียวที่จะทำให้เจ้ายักษ์นั่นกินยานี่ลงไป" id light01

# game/script.rpy:91
translate thai light02:
    ...
    "ความโลภของเจ้ายักษ์จะเป็นจุดจบของมัน มันจะต้องกินเนื้อที่ฉันแอบวางยาของคุณตาลงไปและตายในกองเพลิง" id light02

# game/script.rpy:92
translate thai light03:
...
translate thai strings:
    ...
    new "ขวานอันนี้นี่ใหญ่เท่าตัวฉันเลย ฉันคงจะถือมันสู้กับเจ้ายักษ์ไม่ได้หรอกแต่ฉันสามารถนำมันมาช่วยในการจุดไฟได้"

    # game/script.rpy:28
    old "I might need this kindling. Normal books catch fire easily, but these books might have tricks up their sleeves."
    new "ไม้ฟืนนี่โชกไปด้วยไขมันจากอาหารมื้อที่แล้วของเจ้ายักษ์ ดูท่าจะติดไฟได้ดีทีเดียวเชียว"

    # game/script.rpy:28
    old "My flashlight. I grabbed it when I ran from the cabin last night. I dropped it when I tripped. It doesn't work anymore."
    new "ไฟฉายของคุณตา ฉันจำได้ดีว่าฉันกำลังเอายาไปให้คุณตาตอนที่เจ้ายักษ์เอาตัวเขาไป"
    ...
    new "ฉันหวังว่าเจ้าสัตว์เลี้ยงพวกนั้นจะหาฉันไม่เจอนะ"
    ...
    new "ฉันจะจุดไฟก็ต่อเมื่อฉันมีทุกอย่างครบ ตอนนี้ฉันจต้องมีแผนเสียก่อน"
