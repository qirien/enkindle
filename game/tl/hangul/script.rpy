# TODO: Translation updated at 2021-10-28 12:21
translate hangul style default:
    font "fonts/NotoSerifKR-Regular.otf"
    size 36

# game/script.rpy:76
translate hangul start01:
...
translate hangul strings:
    ...
    new "도끼를 밖에서 찾았다. 이것은 오늘 유용하게 쓰일 거야. 내가 항상 이것을 갖고 다녔으면 좋겠어. 내가 그것을 안고 잠들더라도 그것은 내일 없어질 거야."
    ...
    new "불 밝히기에 좋겠어, 무기로 훌륭해. 대단한 발견이야."
    ...
    new "나는 살아남기 위해 불을 피워야 해 하지만 내가 필요한 모든 것이 나에겐 없어."
